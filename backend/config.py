...
MODEL_PATH = "/models/llama3_2_1b_instruct_f32/dllama_model_llama3.2-1b-instruct_f32.m"
TOKENIZER_PATH = "/models/llama3_2_1b_instruct_f32/dllama_tokenizer_llama3.t"
...
WORKER_IPS = ["172.20.0.11:9998"]

# Estimated range to simulate 
LATENCY_MIN = 0.04 # ex: 0.01 = 10 milliseconds
LATENCY_MAX = 0.08 # ex: 0.05 = 50 milliseconds
